...
### 第三点五部分：架构模式对比 ⭐ NEW
- [第 9.5 章：Profile 实例 vs Agent 模式](#第 95 章 profile 实例 vs agent 模式)

### 第四部分：认证与同步
- [第 10 章：认证配置](#第 10 章认证配置)
- [第 11 章：常见问题排查](#第 11 章常见问题排查)

### 第五部分：实例间通信
- [第 12 章：通信机制](#第 12 章通信机制)
- [第 13 章：任务下达方式](#第 13 章任务下达方式)
- [第 14 章：状态监控](#第 14 章状态监控)

### 第六部分：飞书集成
- [第 15 章：飞书应用配置](#第 15 章飞书应用配置)
- [第 16 章：飞书路由绑定](#第 16 章飞书路由绑定)
- [第 17 章：配对授权流程](#第 17 章配对授权流程)

### 第七部分：运维与管理
- [第 18 章：日常运维](#第 18 章日常运维)
- [第 19 章：配置验证清单](#第 19 章配置验证清单)

### 第八部分：实战案例
- [第 20 章：ClawClock 项目协作](#第 20 章 clawclock 项目协作)
- [第 21 章：配置错误修复实录](#第 21 章配置错误修复实录)
...
### 第 9.5 章：Profile 实例 vs Agent 模式
